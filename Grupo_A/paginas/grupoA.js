...
equipos.forEach((equipo) => {
  ...
  card.innerHTML = `     <img src="${equipo.bandera}" alt="Bandera de ${equipo.nombre}">     <h3>${equipo.nombre}</h3>     <span class="badge">${equipo.grupo}</span>     <a href="${equipo.pagina}" class="btn-ficha">Ver ficha</a>
  `;
